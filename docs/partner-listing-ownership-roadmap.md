...
| 4.6D2 | Event-policy v1.1 enforcement cutover and removal of routine event review | Browser journeys passed; one focused schedule-timezone notification retest remains before Phase 5 |
