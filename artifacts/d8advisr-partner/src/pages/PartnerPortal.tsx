...
export function PartnerPortal() {
  ...
  if (profile && !editingApplication) {
    ...
    const message = isRejected
      ? 'The D8 team reviewed your partner application and could not approve it yet.'
      : profile.status === 'needs_update'
        ? 'The D8 team needs more information before your partner tools can go live.'
          ...
          <>
            ...
            <div>
              ...
              <p className="text-[11px] text-gray-400 mt-1.5 leading-snug">
                Used by D8 during partner review and account support.
              </p>
            </div>
