...
const ALL_EVENTS: Record<string, EventData> = {
  ...
  x1: {
    ...
    spotsLeft: 12,
    totalCapacity: 80,
    organizer: 'Candlelight Events',
    organizerVerified: true,
    highlights: ['Live string quartet', 'Candlelit atmosphere', 'Historic venue', 'Under 2 hours'],
  },
  x2: {
    id: 'x2',
    ...
    spotsLeft: 45,
    totalCapacity: 100,
    organizer: 'Rooftop Cinema Co.',
    organizerVerified: true,
    highlights: ['Open-air rooftop', 'Blankets provided', 'Bar available', 'Doors at 8:30 PM'],
  },
  x3: {
    id: 'x3',
    ...
    emoji: '🎨',
    category: 'Group',
    venueName: 'Arts District Open Ground',
    venueId: '4',
    ...
    spotsLeft: 999,
    totalCapacity: 1000,
    organizer: 'Arts District Collective',
    organizerVerified: false,
    highlights: ['Free entry', 'Live painting', 'Street food', 'Open to all'],
  },
};
